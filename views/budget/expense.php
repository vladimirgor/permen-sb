...
$this->title = 'Ввод расходов';
$this->params['breadcrumbs'][] = $this->title;

if ( empty($ref) ) :?> <p>Добавьте ваши статьи расходов в разделе "Статьи доходов и расходов", пожалуйста.</p>
<?php else: ?>
<div class="site-login">
    <h1><?= Html::encode($this->title) ?></h1>
    <p>Для добавления расхода в бюджет  выберите статью и введите сумму расхода, пожалуйста.</p>
    ...
    <div class="form-group">
        <?= Html::submitButton('Добавить расход в бюджет', ['class' => 'btn btn-primary',
            'id' => 'add_inc_exp']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
