...
$this->params['breadcrumbs'][] = ['label'=>'Статьи доходов ', 'url' => '/refincome'];
$this->title = 'Закрытие статьи доходов';
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="site-login">
    <h1><?= Html::encode($this->title). '-'. $income->article?></h1>
    <p>Для закрытия статьи дохода введите дату закрытия, пожалуйста.</p>
    ...
    <div class="form-group">
        <?= Html::submitButton('Закрыть статью дохода', ['class' => 'btn btn-danger']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
