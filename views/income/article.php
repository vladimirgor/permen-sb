...
$this->title = 'Добавление статьи доходов';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-login">
    <h1><?= Html::encode($this->title) ?></h1>
    <p>Для добавления статьи дохода заполните следующее поле, пожалуйста.</p>
    ...
    <div class="form-group">
        <?= Html::submitButton('Добавить статью дохода', ['class' => 'btn btn-primary']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
